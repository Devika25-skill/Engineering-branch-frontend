        ...
        <div className="flex items-start gap-3 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-2 mb-2">
              <div className="flex-1 min-w-0">
                <h3
                  className="text-sm font-semibold text-gray-900 leading-tight mb-1"
                  title={college?.name || "Unknown College"}
                >
                ...
                <div className="flex items-center gap-1 text-xs text-gray-500">
                  <MapPin size={10} />
                  <span>
                    {truncateText(college?.city || "Unknown Location", 20)}
                  </span>
                  {college?.id && (
                    <>
            ...
            <div className="bg-blue-50 rounded-lg p-2 mb-2">
              <div className="text-xs">
                <div
                  ...
                  title={course_name || "Unknown Course"}
                >
                ...
                <div className="flex flex-wrap gap-1">
                  {choice_code && (
                    <span className="text-blue-700 bg-blue-200 px-1.5 py-0.5 rounded text-xs">
                      ...
                      {String(choice_code).includes("U") ? "- Un-Aided" : ""}
                    </span>
                  )}
                  {cutoff_percentile && (
                    <span className="text-blue-700 bg-blue-200 px-1.5 py-0.5 rounded text-xs">
            ...
            <div className="bg-gray-50 rounded-lg p-2">
              <div className="grid grid-cols-1 gap-2 text-xs">
                ...
                <div className="col-span-2">
                  ...
                  <span
                    className={`ml-1 font-semibold ${getProbabilityColor(admission_probability)}`}
                  >
                    {admission_probability || "N/A"}%
                    <span className="ml-1 font-medium">
                      -{" "}
                      {probability_message.split("-")[0].split("chances")[0] ||
                        ""}
                    </span>
                  </span>
                </div>
