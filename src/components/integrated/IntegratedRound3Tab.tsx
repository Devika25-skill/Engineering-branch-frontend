          ...
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-yellow-700 text-sm max-w-md mx-auto">
                Round 3 is the final round of counseling with remaining vacant seats. 
                Best opportunity for last-minute admissions.
              </p>
            </div>
            <div className="flex items-center justify-center gap-2 text-sm text-yellow-600">
              <Sparkles className="w-4 h-4" />
              <span>Final chance for your dream college!</span>
            </div>
          </div>
        </CardContent>
      </Card>
