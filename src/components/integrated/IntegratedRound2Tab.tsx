                ...
                <div className="space-y-4">  
                  {round2Recommendations.length === 0 ? (
                    ...
                    <div className="grid gap-4">
                      ...
                      {round2Recommendations.slice(0, 3).map((recommendation, index) => (
                      ...
                      {round2Recommendations.length > 3 && (
                        <>
                          {!isUnlocked ? (
                            <div className="relative">
                              {/* Blurred recommendations */}
                              <div className="filter blur-sm pointer-events-none space-y-4">
                                {round2Recommendations.slice(3, 6).map((recommendation, index) => (
                                  <IntegratedRecommendationCard
                              ...
                              <div className="absolute inset-0 bg-white/80 backdrop-blur-sm flex items-center justify-center rounded-lg">
                                <div className="text-center p-6 bg-white rounded-lg shadow-lg border-2 border-blue-200 max-w-sm mx-4">
                                  ...
                                  <p className="text-sm text-gray-600 mb-4">
                                    Get access to {round2Recommendations.length - 3} more personalized recommendations
                                  </p>
                                  <PremiumGate 
                            ...
                            round2Recommendations.slice(3).map((recommendation, index) => (
                              <IntegratedRecommendationCard
