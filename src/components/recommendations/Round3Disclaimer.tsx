...
export const Round3Disclaimer = () => {
  return (
    <Alert className="border-amber-200 bg-amber-50 text-amber-800 mb-6">
      <AlertTriangle className="h-4 w-4 text-amber-600" />
      <AlertDescription className="text-sm font-medium">
        <strong>Important Disclaimer:</strong> These Round 3 college recommendations are based on previous year's Round 3 cutoff data and your provided information. 
