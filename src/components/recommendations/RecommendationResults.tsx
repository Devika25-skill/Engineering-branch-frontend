    ...
    <div className="space-y-6">
      ...
      {recommendations && recommendations.length > 0 ? (
        <>
          ...
          {/* Results Summary with Download Button */}
                ...
                <div id="blurred-section" className="relative mt-4 z-10">
                  ...
                  <div className="text-center bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg mb-4 border-2 border-blue-200">
                    ...
                    <h3 className="text-xl font-bold text-gray-800 mb-2">
                      🔒 Unlock Full Report & Download
                    </h3>
                    <p className="text-gray-600 text-sm mb-4">
                      {categorizedRecommendations.length - 10} more recommendations + PDF download
                    </p>
                    ...
                    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                      <DialogTrigger asChild>
                        <Button
                          ...
                          className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center gap-2 mx-auto min-h-[44px] touch-manipulation"
                        >
                          <Unlock size={16} />
                          Unlock Now
                        </Button>
                  ...
                  <div className="blur-sm pointer-events-none space-y-4">
                    {categorizedRecommendations.slice(10, Math.min(15, categorizedRecommendations.length)).map((recommendation, index) => (
                      <RecommendationCard
