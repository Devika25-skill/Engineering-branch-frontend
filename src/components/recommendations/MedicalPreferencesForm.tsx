...
export const MedicalPreferencesForm = ({
  data,
  onUpdate,
  validationErrors = [],
}: MedicalPreferencesFormProps) => {
  const [selectedPrograms, setSelectedPrograms] = useState<string[]>(
    data.preferredMedicalPrograms || [],
  );
                    ...
                    <Droppable droppableId="programs">
                      {(provided) => (
                        <div
                          ...
                          className="space-y-2"
                        >
                          {selectedPrograms.map((programCode, index) => {
                            const programLabel =
                                ...
                                {(provided) => (
                                  ...
                                  >
                                    ...
                                    <Button
                                      ...
                                      size="sm"
                                      variant="ghost"
                                      onClick={() => removeProgram(programCode)}
          ...
          <CardContent className="space-y-6">
            {availableCities.length > 10 ? (
              <div className="relative">
                <Plus
                  size={16}
                  className="text-green-600 absolute left-4 top-1/2 -translate-y-1/2 z-10 pointer-events-none"
                />
                <SearchableSelect
