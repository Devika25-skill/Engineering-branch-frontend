        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="animate-fade-in">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-white to-purple-100 bg-clip-text text-transparent leading-tight">
              ...
              <span className="block text-sm sm:text-4xl md:text-5xl lg:text-6xl mt-2 text-white-300 leading-tight sm:leading-tight md:leading-tight lg:leading-tight">Engineering, BCA, BBA, B-Pharmacy</span>
