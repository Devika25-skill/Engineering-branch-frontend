...
const AppRegister = () => {
    ...
    const onRegister = async () => {
        ...
        setIsVerifying(true);
        try {
            // First validate OTP implicitly by calling pre-register (the BE validates it)
            // But we first show payment options if OTP is valid?
            // Actually, let's keep it simple: After OTP entry, show the Offer/Payment screen.
        ...
        try {
            ...
            if (response.success) {
                toast({
                    ...
                    description: isPaid ? "Welcome! You've grabbed the special offer." : "Welcome! Your account has been created.",
                });
                ...
                <div className="max-w-xl mx-auto">
                    <Card className="shadow-2xl border-none bg-white/90 backdrop-blur-md overflow-hidden animate-in zoom-in-95 duration-500">
                        ...
                        <CardContent className="p-6 sm:p-10 space-y-6">
                            ...
                            <p className="text-center text-[11px] text-gray-400 font-medium uppercase tracking-widest px-4">
