  ...
  const generatePDF = async (recommendations: MedicalCollegeRecommendation[], formData: any) => {
    ...
    try {
      ...
      const addHeader = (pageNum: number = 1) => {
        ...
        pdf.text('Medical College Recommendations Report', pageWidth - margin, headerYPos + 20, { align: 'right' });
      ...
      sortedRecommendations.forEach((rec) => {
        ...
        if (yPosition > pageHeight - 40 || collegesOnCurrentPage >= maxCollegesPerPage) {
          pdf.addPage();
        ...
        pdf.text(`Closing Rank: ${rec.closing_rank || 'N/A'}`, margin + 15, yPosition + 26);
        ...
        pdf.text(`${rec.admission_probability || 0}%`, margin + 125, yPosition + 18);
      ...
      pdf.setFont('helvetica', 'normal');
      pdf.setTextColor(55, 65, 81);
      const disclaimerText = "These medical college recommendations are based on previous year's admission data and your provided NEET information. Please verify all details including current cutoffs, fees, seat availability, and admission requirements before submitting your application forms.";
      ...
      const steps = [
        {
          ...
          content: 'Simply copy the colleges exactly as they appear on this list, from top to bottom, into your official medical counseling application form.'
        },
        {
          title: '2. Dream & Reach First:',
          content: 'The colleges at the top of this list are your "Dream" and "Reach" options. While your NEET rank may not match last year\'s closing ranks, placing them first gives you the best opportunity to secure admission if seats open up in subsequent rounds.'
        },
        {
          title: '3. Match & Safety Next:',
          content: 'The "Match" and "Safety" colleges are strategically positioned to ensure you secure admission to the best possible college that fits your NEET rank and preferences, even if top choices don\'t work out.'
        },
        {
          title: '4. No Guesswork, No Mistakes:',
          content: 'This optimized sequence eliminates common errors and guesswork, ensuring you leverage every opportunity without missing out on a valuable medical seat.'
        }
      ];
      ...
      const confidenceText = "By following this recommended order, you're not just filling a form - you're executing a smart strategy for your medical career. Go ahead, fill your form with confidence!";
      ...
      const categories = [
        {
          ...
          description: 'These are colleges that perfectly align with your preferences but your NEET rank is below their typical closing rank. Challenging but worth including for your highest aspirations.'
        },
        {
          name: 'Reach Colleges',
          chance: '50-70% chance',
          ...
          description: 'Ambitious but within grasp. Your NEET rank is close to their closing rank. You have a solid chance with these excellent options.'
        },
        {
          name: 'Match Colleges',
          chance: '75-90% chance',
          ...
          description: 'Great fit for your profile. Your NEET rank is comfortably within their range. Very strong likelihood of admission.'
        },
        {
          ...
          description: 'Highly probable admission. Your NEET rank is well above their closing rank. These provide peace of mind and guaranteed admission.'
        }
      ];
